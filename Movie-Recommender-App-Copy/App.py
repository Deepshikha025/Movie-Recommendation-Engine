...
with open(r'C:\Users\Deepshikha\Microsoft Engage\Movie-Recommender-App-Copy\Data\movie_data.json', 'r+', encoding='utf-8') as f:
    data = json.load(f)
with open(r'C:\Users\Deepshikha\Microsoft Engage\Movie-Recommender-App-Copy\Data\movie_titles.json', 'r+', encoding='utf-8') as f:
...
def run():
    img1 = Image.open(r'C:\Users\Deepshikha\Microsoft Engage\Movie-Recommender-App-Copy\meta\logo.jpg')
    ...
    if cat_op == category[0]:
        ...
        if dec == 'No':
            if select_movie == '--Select--':
                ...
                no_of_reco = st.slider('Number of movies you want Recommended:', min_value=1, max_value=20, step=1)
        ...
        if dec == 'No':
            if sel_gen:
                ...
                no_of_reco = st.number_input('Number of movies:', min_value=1, max_value=20, step=1)
