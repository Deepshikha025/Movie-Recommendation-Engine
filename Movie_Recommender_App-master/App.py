...
with open(r'C:\Users\Deepshikha\Microsoft Engage\Movie_Recommender_App-master\Data\movie_data.json', 'r+', encoding='utf-8') as f:
    data = json.load(f)
with open(r'C:\Users\Deepshikha\Microsoft Engage\Movie_Recommender_App-master\Data\movie_titles.json', 'r+', encoding='utf-8') as f:
...
def run():
    img1 = Image.open(r'C:\Users\Deepshikha\Microsoft Engage\Movie_Recommender_App-master\meta\logo.jpg')
    img1 = img1.resize((250,250),)
    st.image(img1,use_column_width=False)
    st.title("Movie Recommender System")
    st.markdown('''<h4 style='text-align: left; color: #d73b5c;'> "IMDB 5000 Movie Dataset"</h4>''',
    ...
    if cat_op == category[0]:
        ...
        if dec == 'No':
            if select_movie == '--Select--':
                ...
                no_of_reco = st.slider('Number of movies you want Recommended:', min_value=1, max_value=5, step=1)
        ...
        if dec == 'No':
            if sel_gen:
                ...
                no_of_reco = st.number_input('Number of movies:', min_value=1, max_value=5, step=1)
